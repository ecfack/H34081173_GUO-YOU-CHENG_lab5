...
class Tower:
    ...
    def __eq__(self, other):
        """
        return True if the two towers' rect.center are equal.
        """
        return True if self.rect.center == other.rect.center else False
    def __ne__(self, other):
        """
        return True if the two towers' rect.center aren't equal.
        """
...
class TowerGroup:
    ...
    def upgrade(self):
        ...
        self.selected_tower.level=min(self.selected_tower.level+1,5)
        pass
    ...
    def sell(self):
        ...
        #find and pop the selected tower from __towers
        for i in range(0,len(self.__towers)):
            if self.selected_tower==self.__towers[i]:
                self.__towers.pop(i)
                self.selected_tower=None
                self.upgrade_menu=None
        pass
